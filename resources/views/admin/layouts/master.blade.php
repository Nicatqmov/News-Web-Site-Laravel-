...
<head>
    ...
    <link rel="stylesheet" href="{{asset('admin_assets/css/lineicons.css')}}" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" href="{{asset('admin_assets/css/materialdesignicons.min.css')}}" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" href="{{asset('admin_assets/css/fullcalendar.css')}}" />
    <link rel="stylesheet" href="{{asset('admin_assets/css/fullcalendar.css')}}" />
